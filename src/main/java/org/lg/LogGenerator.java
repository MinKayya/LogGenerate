...
public class LogGenerator implements Runnable {
    ...
    private final static long MIN_SLEEP_TIME = 500;
    private final static long MAX_SLEEP_TIME = 60 * 1000;
    ...
    public void run() {
        ...
        while (isDuration(startTime)) {
            long sleepTime = MIN_SLEEP_TIME + Double.valueOf(rand.nextDouble() * (MAX_SLEEP_TIME - MIN_SLEEP_TIME)).longValue();
            try {
